...
const PaymentsTable = ({loading, payments, error, totals, student}) => {
    ...
    >
        ...
        >
            ...
            <tr>
                ...
                <th style={{width: 220, textAlign: 'center', padding: '12px 6px'}}>Date and time of payment</th>
            ...
            {payments?.map((payment) => (
                <tr key={payment.id}>
                    <td style={{textAlign: 'center', width: 70}}>
                        {payment?.status && <DoneOutlineRoundedIcon/>}
                    </td>
                    ...
                    <td style={{textAlign: 'center', width: 220}}>
                        {payment?.time && <Typography level="body-s"> {new Date(payment?.time).toLocaleString('en-GB',
               ...
               <Chip
                ...
                >
                    ...
                    <Chip
                        ...
                        size="lg"
                        color={'danger'}
                    > Unpaid: {totals?.unpaidTotal}
                    </Chip>
                    <Chip
                        variant="soft"
                        size="lg"
                        color={'neutral'}
                    > Total: {parseInt(totals?.unpaidTotal) + parseInt(totals?.paidTotal)}
                    </Chip>
            </Box>}
